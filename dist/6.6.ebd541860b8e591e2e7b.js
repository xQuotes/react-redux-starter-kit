...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddFormula = (_dec = (0, _mobxReact.inject)('formulaStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	  _inherits(AddFormula, _React$Component);
	
	  function AddFormula(props) {
	    _classCallCheck(this, AddFormula);
	
	    return _possibleConstructorReturn(this, (AddFormula.__proto__ || Object.getPrototypeOf(AddFormula)).call(this, props));
	  }
	
	  _createClass(AddFormula, [{
	    key: 'render',
	    value: function render() {
	      var formulaStore = this.props.formulaStore;
	
	      var paramsData = formulaStore.params;
	      var formula = formulaStore.list.getById(paramsData.id) || {};
	      var formDataTitileServer = _.map(formulaStore.updateFields, function (v, k) {
	        return _.assign({}, {
	          name: k,
	          label: v,
	          fieldOptions: {
	      ...
	      formDataTitileServer = [{
	        ...
	        label: 'id',
	        fieldOptions: {
	          initialValue: paramsData.actionType == 'clone' ? undefined : formula.id
	        }
	      }].concat(_toConsumableArray(formDataTitileServer));
	
	      return React.createElement(_commonInfoAdd2.default, { store: formulaStore, title: formDataTitileServer });
	    }
	  }]);
	
	  return AddFormula;
	}(React.Component)) || _class) || _class);
	exports.default = AddFormula;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _add = __webpack_require__(1280);
	...
	var Formulas = (_dec = (0, _mobxReact.inject)('formulaStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	  _inherits(Formulas, _React$Component);
	
	  function Formulas(props) {
	    _classCallCheck(this, Formulas);
	
	    return _possibleConstructorReturn(this, (Formulas.__proto__ || Object.getPrototypeOf(Formulas)).call(this, props));
	  }
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(_commonInfoList2.default, {
	          ...
	          bcData: bcData,
	          downloadCSV: _Api2.default.downloadFormulaCSV,
	          funcEnName: 'formula'
	        }),
...
//# sourceMappingURL=6.6.ebd541860b8e591e2e7b.js.map