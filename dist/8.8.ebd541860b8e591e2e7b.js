...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddNews = (_dec = (0, _mobxReact.inject)('newsStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	  ...
	  _createClass(AddNews, [{
	    key: 'newsIpExists',
	    value: function newsIpExists(rule, value, callback) {
	      if (!value) {
	        callback();
	      } else {
	        if (!ipReg.test(value)) {
	    ...
	    key: 'newsPortExists',
	    value: function newsPortExists(rule, value, callback) {
	      if (!value) {
	        callback();
	      } else {
	    ...
	    value: function render() {
	      var newsStore = this.props.newsStore;
	
	      var paramsData = newsStore.params;
	      var news = newsStore.list.getById(paramsData.id) || {};
	      var formDataTitileServer = _.map(newsStore.updateFields, function (v, k) {
	        return _.assign({}, {
	          name: k,
	          label: v,
	          fieldOptions: {
	      ...
	      return React.createElement(_commonInfoAdd2.default, { store: newsStore, title: formDataTitileServer });
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _add = __webpack_require__(1286);
	...
	var Newss = (_dec = (0, _mobxReact.inject)('newsStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	  _inherits(Newss, _React$Component);
	
	  function Newss(props) {
	    _classCallCheck(this, Newss);
	
	    return _possibleConstructorReturn(this, (Newss.__proto__ || Object.getPrototypeOf(Newss)).call(this, props));
	  }
	
	  _createClass(Newss, [{
	    key: 'render',
	    value: function render() {
	      var bcData = ['首页', '资讯管理', '列表'];
	      return React.createElement(
	        ...
	        React.createElement(_commonInfoList2.default, {
	          ...
	          bcData: bcData,
	          downloadCSV: _Api2.default.downloadNewsCSV,
	          funcEnName: 'news'
	        }),
...
//# sourceMappingURL=8.8.ebd541860b8e591e2e7b.js.map