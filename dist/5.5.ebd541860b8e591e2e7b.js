...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddTable = (_dec = (0, _mobxReact.inject)('tableStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	  _inherits(AddTable, _React$Component);
	
	  function AddTable(props) {
	    _classCallCheck(this, AddTable);
	
	    return _possibleConstructorReturn(this, (AddTable.__proto__ || Object.getPrototypeOf(AddTable)).call(this, props));
	  }
	
	  _createClass(AddTable, [{
	    key: 'render',
	    value: function render() {
	      var tableStore = this.props.tableStore;
	
	      var paramsData = tableStore.params;
	      var table = tableStore.list.getById(paramsData.id) || {};
	      var formDataTitileServer = _.map(tableStore.updateFields, function (v, k) {
	        return _.assign({}, {
	          name: k,
	          label: v,
	          fieldOptions: {
	      ...
	      return React.createElement(_commonInfoAdd2.default, { store: tableStore, title: formDataTitileServer });
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _add = __webpack_require__(1274);
	...
	var Tables = (_dec = (0, _mobxReact.inject)('tableStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	  _inherits(Tables, _React$Component);
	
	  function Tables(props) {
	    _classCallCheck(this, Tables);
	
	    return _possibleConstructorReturn(this, (Tables.__proto__ || Object.getPrototypeOf(Tables)).call(this, props));
	  }
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(_commonInfoList2.default, {
	          ...
	          bcData: bcData,
	          downloadCSV: _Api2.default.downloadTableCSV,
	          funcEnName: 'table'
	        }),
...
//# sourceMappingURL=5.5.ebd541860b8e591e2e7b.js.map